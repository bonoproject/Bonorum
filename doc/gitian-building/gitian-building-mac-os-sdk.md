...
The script [extract-osx-sdk.sh](https://github.com/bonorumcoin-project/bonorumcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
bonorumcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/bonorumcoin-project/bonorumcoin/blob/master/doc/README_osx.md) for troubleshooting tips.
