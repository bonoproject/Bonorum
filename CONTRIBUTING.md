Contributing to BonorumCoin
============================

The BonorumCoin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bonorumcoin-project/bonorumcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BonorumCoin project, and is not to be
confused with overall BonorumCoin Network Protocol consensus changes.

Whether a pull request is merged into BonorumCoin rests with the project merge
...
Patches that change BonorumCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the BonorumCoin consensus, it must have been
...
The project leader is the release manager for each BonorumCoin release.
