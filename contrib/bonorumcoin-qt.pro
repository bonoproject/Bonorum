...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/bonorumcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bonorumcoin-cli.cpp \
           src/bonorumcoin-tx.cpp \
           src/bonorumcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/bonorumcoin.qrc src/qt/bonorumcoin_locale.qrc

TRANSLATIONS += src/qt/locale/bonorumcoin_bg.ts \
                src/qt/locale/bonorumcoin_de.ts \
                src/qt/locale/bonorumcoin_en.ts \
                src/qt/locale/bonorumcoin_es.ts \
                src/qt/locale/bonorumcoin_fi.ts \
                src/qt/locale/bonorumcoin_fr.ts \
                src/qt/locale/bonorumcoin_it.ts \
                src/qt/locale/bonorumcoin_ja.ts \
                src/qt/locale/bonorumcoin_pl.ts \
                src/qt/locale/bonorumcoin_pt.ts \
                src/qt/locale/bonorumcoin_ru.ts \
                src/qt/locale/bonorumcoin_sk.ts \
                src/qt/locale/bonorumcoin_sv.ts \
                src/qt/locale/bonorumcoin_vi.ts \
                src/qt/locale/bonorumcoin_zh_CN.ts \
                src/qt/locale/bonorumcoin_zh_TW.ts
