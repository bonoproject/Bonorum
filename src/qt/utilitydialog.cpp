...
#include "qt/bonorumcoin/qtutils.cpp"
                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BonorumCoin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About BonorumCoin"));
        ...
        licenseInfoHTML.replace(uri, "<a style='color: #FE8899;text-decoration:none'  href=\"\\1\">\\1</a>");
        ...
        QString header = tr("Usage:") + "\n" +
                         "  bonorumcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BonorumCoin is shutting down...") + "<br /><br />" +
