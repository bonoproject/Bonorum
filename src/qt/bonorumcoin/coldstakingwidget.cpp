...
#include "qt/bonorumcoin/forms/ui_coldstakingwidget.h"
#include "qt/bonorumcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/bonorumcoin/requestdialog.h"
#include "qt/bonorumcoin/tooltipmenu.h"
#include "qt/bonorumcoin/furlistrow.h"
...
#include "qt/bonorumcoin/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(BonorumCoinGUI* parent) :
    PWidget(parent),
	...
	isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your BONOs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept BONO delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select BONO outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 BONO" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
