...
#include "qt/bonorumcoin/forms/ui_masternodewizarddialog.h"
	...
	walletModel(model)
{
	...
	ui->lineEditPort->setPlaceholderText("e.g 1619");
...
bool MasterNodeWizardDialog::createMN() {
	if (walletModel) {
		...
		SendCoinsRecipient sendCoinsRecipient(QString::fromStdString(address.ToString()), QString::fromStdString(alias), CAmount(1000) * COIN, "");
