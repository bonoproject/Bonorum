...
#include "qt/bonorumcoin/coincontrolbonowidget.h"
#include "qt/bonorumcoin/forms/ui_coincontrolbonowidget.h"

CoinControlBonoWidget::CoinControlBonoWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlBonoWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select BONO Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("BONO");
    ...
    ui->labelValueAfter->setText("0.00 BONO");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BONO");
    ui->labelValueFee->setText("0.00 BONO");
...
CoinControlBonoWidget::~CoinControlBonoWidget()
{
    delete ui;
}
