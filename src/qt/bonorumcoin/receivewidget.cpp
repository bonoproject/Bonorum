...
#include "qt/bonorumcoin/forms/ui_receivewidget.h"
...
#include "qt/bonorumcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(BonorumCoinGUI* parent) :
	PWidget(parent),
	ui(new Ui::ReceiveWidget)
{
	...
	ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive BONO."));
