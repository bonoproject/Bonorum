...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, BonorumCoinGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, BonorumCoinGUI *gui, double posX = 3);
