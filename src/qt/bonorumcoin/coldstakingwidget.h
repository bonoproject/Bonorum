...
#include "qt/bonorumcoin/furabstractlistitemdelegate.h"
#include "qt/bonorumcoin/txviewholder.h"
#include "qt/bonorumcoin/tooltipmenu.h"
#include "qt/bonorumcoin/sendmultirow.h"
#include "qt/bonorumcoin/coldstakingmodel.h"
#include "qt/bonorumcoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(BonorumCoinGUI* parent);
    ~ColdStakingWidget();
