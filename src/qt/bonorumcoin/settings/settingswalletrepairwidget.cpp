...
#include "qt/bonorumcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/bonorumcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BonorumCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BonorumCoinGUI::handleRestart()
