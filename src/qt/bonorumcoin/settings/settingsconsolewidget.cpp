...
#include "qt/bonorumcoin/settings/forms/ui_settingsconsolewidget.h"
...
const struct {
    ...
    const char* source;
        ...
        {"cmd-request", "://ic-transaction-received"},
        {"cmd-reply", "://ic-transaction-sent"},
        {"cmd-error", "://ic-transaction-sent"},
        {"misc", "://ic-transaction-staked"},
        {NULL, NULL}};
...
#include "qt/bonorumcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(BonorumCoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the BonorumCoin RPC console.") + "<br>" +
