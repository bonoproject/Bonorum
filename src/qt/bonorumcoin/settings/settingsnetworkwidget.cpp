...
#include "qt/bonorumcoin/settings/settingsnetworkwidget.h"
#include "qt/bonorumcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/bonorumcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BonorumCoinGUI* _window, QWidget *parent) :
