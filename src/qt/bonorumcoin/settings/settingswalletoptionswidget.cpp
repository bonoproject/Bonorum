...
#include "qt/bonorumcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/bonorumcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BonorumCoinGUI* _window, QWidget *parent) :
