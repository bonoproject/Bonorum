...
#include "qt/bonorumcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(BonorumCoinGUI* _window, QWidget *parent) :
