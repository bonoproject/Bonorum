...
#include "qt/bonorumcoin/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(BonorumCoinGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsBitToolWidget)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText(tr("Enter a BonorumCoin address"));
...
void SettingsBitToolWidget::importAddressFromDecKey(){
    ...
    ui->statusLabel_DEC->setText(tr("Successfully added bonoate key to the wallet"));
}
