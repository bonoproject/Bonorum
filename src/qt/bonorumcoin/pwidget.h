...
#include <QWidget>
#include <QString>
#include "qt/bonorumcoin/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(BonorumCoinGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    BonorumCoinGUI* getWindow() { return this->window; }
