...
#ifndef BonorumCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define BonorumCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //BonorumCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
