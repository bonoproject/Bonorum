...
#include "qt/bonorumcoin/forms/ui_masternodeswidget.h"
#include "qt/bonorumcoin/qtutils.h"
#include "qt/bonorumcoin/mnrow.h"
#include "qt/bonorumcoin/mninfodialog.h"

#include "qt/bonorumcoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(BonorumCoinGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:1619 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (COIN * 1000)){
            inform(tr("Not enough balance to create a masternode, 1,000 BONO required."));
            return;
        }
        showHideOp(true);
