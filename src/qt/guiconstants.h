...
/* BonorumCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BonorumCoin"
#define QAPP_ORG_DOMAIN "bonorumcoin.org"
#define QAPP_APP_NAME_DEFAULT "BonorumCoin-Qt"
#define QAPP_APP_NAME_TESTNET "BonorumCoin-Qt-testnet"
