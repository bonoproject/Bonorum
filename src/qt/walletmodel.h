...
#ifndef BonorumCoin_QT_WALLETMODEL_H
#define BonorumCoin_QT_WALLETMODEL_H
...
/** Interface to BonorumCoin wallet from Qt view code. */
...
#endif // BonorumCoin_QT_WALLETMODEL_H
