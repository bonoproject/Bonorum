...
/** Utility functions used by the BonorumCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BonorumCoin addresses in monospace font
...
// Parse "bonorumcoin:" URI into recipient object, return true on successful parsing
