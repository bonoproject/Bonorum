...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(BONO);
    unitlist.append(mBONO);
    unitlist.append(uBONO);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case BONO:
        return QString("bonorumcoin");
    case mBONO:
        return QString("mbonorumcoin");
    case uBONO:
        return QString::fromUtf8("ubonorumcoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BONO:
            return QString("BONO");
        case mBONO:
            return QString("mBONO");
        case uBONO:
            return QString::fromUtf8("μBONO");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case BONO:
            return QString("tBONO");
        case mBONO:
            return QString("mtBONO");
        case uBONO:
            return QString::fromUtf8("μtBONO");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BONO:
            return QString("BONO");
        case mBONO:
            return QString("Milli-BONO (1 / 1" THIN_SP_UTF8 "000)");
        case uBONO:
            return QString("Micro-BONO (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case BONO:
            return QString("TestBONOs");
        case mBONO:
            return QString("Milli-TestBONO (1 / 1" THIN_SP_UTF8 "000)");
        case uBONO:
            return QString("Micro-TestBONO (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
