...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BonorumCoin"),
     ...
     * override -datadir in the bonorumcoin.conf file in the default data directory
     * (to be consistent with bonorumcoind behavior)
     */
