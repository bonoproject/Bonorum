...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop BonorumCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BonorumCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BonorumCoin features */
        {"bonorumcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bonorumcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bonorumcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bonorumcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bonorumcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bonorumcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bonorumcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bonorumcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bonorumcoin", "startmasternode", &startmasternode, true, true, false},
        {"bonorumcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bonorumcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bonorumcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bonorumcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bonorumcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bonorumcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bonorumcoin", "preparebudget", &preparebudget, true, true, false},
        {"bonorumcoin", "submitbudget", &submitbudget, true, true, false},
        {"bonorumcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bonorumcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bonorumcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bonorumcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bonorumcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bonorumcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bonorumcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bonorumcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"bonorumcoin", "mnsync", &mnsync, true, true, false},
        {"bonorumcoin", "spork", &spork, true, true, false},
        {"bonorumcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> bonorumcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1618/\n";
}
