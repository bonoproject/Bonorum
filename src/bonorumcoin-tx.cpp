...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BonorumCoin bonorumcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bonorumcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bonorumcoin transaction") + "\n" +
                               "  bonorumcoin-tx [options] -create [commands]   " + _("Create hex-encoded bonorumcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bonorumcoin transaction
