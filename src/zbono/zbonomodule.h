...
//
#ifndef BonorumCoin_ZBONOMODULE_H
#define BonorumCoin_ZBONOMODULE_H
...
public:
    ...
    bool Verify(const libzerocoin::Accumulator& a, bool verifyParams = true) const;
...
#endif //BonorumCoin_ZBONOMODULE_H
