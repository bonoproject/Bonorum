...
#ifndef BonorumCoin_ZBONOWALLET_H
#define BonorumCoin_ZBONOWALLET_H
...
public:
    CzBONOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBONO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBONO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //BonorumCoin_ZBONOWALLET_H
