...
from fake_stake.base_test import BonorumCoin_FakeStakeTest

class zBONOwrappedSerialsTest(BonorumCoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBONOs..." % DENOM_TO_USE)
