...
from test_framework.bonorumcoin_node import BonorumCoinTestNode
...
class BonorumCoin_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(BonorumCoinTestNode())
...
if __name__ == '__main__':
    BonorumCoin_ColdStakingTest().main()
